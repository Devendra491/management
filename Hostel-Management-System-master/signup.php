        ...
        <form action="signup_data.php" method="GET">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="v1" placeholder="Roll No" required="required" />
                </div>
            </div>
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="v2" placeholder="First Name" required="required" />
                </div>
            </div>
            <div class=" w3l-form-group">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="v6" placeholder="Year of Study" required="required" />
                </div>
            </div>
