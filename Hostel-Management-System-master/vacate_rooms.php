	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="/admin/admin_home.php"><span class="display"> PVPC</span></a></h1>
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item">
							<a class="nav-link" href="http://localhost/phpd/Hostel-Management-System-master/admin/admin_home.php">Home <span class="sr-only">(current)</span></a>
						</li>
						
						<li class="nav-item">
						<a class="nav-link" href="#">Allocate Room</a>
					...
					<li class="dropdown nav-item">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">Applications
							<b class="caret"></b>
						</a>
						<ul class="dropdown-menu agile_short_dropdown">
							<li>
								<a href="hostel_application1.php">Hostel 1</a>
							</li>
							<li>
								<a href="hostel_application2.php">Hostel 2</a>
							</li>
							<li>
								<a href="hostel_application3.php">Hostel 3</a>
							</li>
							<li>
								<a href="hostel_application4.php">Hostel 4</a>
							</li>
						</ul>
					</li>
					<li class="dropdown nav-item">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">Manage<?php //echo $_SESSION['username']; ?>
							<b class="caret"></b>
						</a>
						<ul class="dropdown-menu agile_short_dropdown">
							<li>
							...
							<li>
								<a href="../recieved_complaints.php">Recieved Complaints</a>
							</li>
							<li>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="admin_home.html">PVPC <span class="display"> </span></a>
		</div>
