				 ...
				 <div class="row">
						...
						<div class="contact-fields-w3ls">
							...
							<div class="contact-fields-w3ls">
							 ...
							 <!-- <div class="col-md-6 contact_left_grid" data-aos="fade-right"> -->
							 <div class="contact-fields-w3ls">
								<!-- <input type="text" name="v3" placeholder="Chatrapati Shivaji Maharaj Hostel" value="Chatrapati Shivaji Maharaj Hostel" required="" > -->
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="v8" placeholder="Paid Fees" required="">
							</div>
                            <label class="contact-fields-w3ls"><h3><b>select hostel</b></h3></lable> <br>                      
                              <select class="" size="1" heigth="20%">
                                    <option style="height:90%;">Chatrapati Shivaji Maharaj Hostel</option>
                                    <option>Savitribali Phule Hostel</option>
                                    <option>Chatrapati Shivaji Maharaj Hostel</option>
                                </select>
