...
<section class="services py-5">
	<div class="container py-lg-5 py-3">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> <b>About Us</b> </h2>
...
<div class="services-bottom stats">
	...
	<div class="container py-lg-5 pb-3">
		<h3 class="heading text-capitalize mb-5"> Our Stats </h3>
		  ...
		  <div class="col-sm-4 col-12 w3_agile_stats_grid-top">
		...
		<div class="col-sm-3 col-12 mt-sm-0 mt-5 w3_agile_stats_grid-top">
			<div class="w3_agile_stats_grid">
				<div class="agile_count_grid_left">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="home.html">PVPC <span class="display"></span></a>
		</div>
