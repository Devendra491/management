	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home_manager.php">PVPC <span class="display"></span></a></h1>
...
<div class="container">
<h3 class="heading text-capitalize mb-sm-5 mb-4"> Applications of Chatrapati Shivaji Maharaj Hostel </h3>
<?php
//    $hostel_id = $_SESSION['hostel_id'];
...
?>
	  ...
	  <?php
        $w=mysqli_connect("localhost","root","","h_m_s")or die('failed to connect'); 
        $v="SELECT * FROM hostel1_db";
        $res=mysqli_query($w,$v);
        $i=1;
