...
<section class="contact py-5">
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Write Your Complaint </h2>
			<div class="mail_grid_w3l">
				<form action="complaint_db.php" method="get">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								 <input type="text" name="rol_no" placeholder="Roll Number" value="<?php echo $_SESSION['rno']; ?>" required="">
							</div>
							<div class="contact-fields-w3ls">
